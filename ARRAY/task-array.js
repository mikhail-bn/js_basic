...
// 4. Вызвать функцию столько раз сколько будет получена посылка. Каждый вызов функции данного скрипта будет подразумевать получение посылки и соответственно удаление элемента массива с начала

// 5. Определить цикл с помещением в тело функции той либо другой

// 6. Следует заметить, что "случайный вариант" уменьшения массива тем или иным способом убытия следует реализовать вызовом той или иной функции случайным образом. Данный пример показывает частный случай условия 3 получили остальные ушли по очереди.
...
//         console.log(arrayFromNumber.push(i));
//     }
//     const firstIndexOfArray = arrayFromNumber.slice(0);
//     const lastIndexOfArray = arrayFromNumber.slice(number);
//     console.log('firstIndexOfArray: ', firstIndexOfArray);
// };
